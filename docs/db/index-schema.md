...
| --- | ------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 1   | Auth & Identity     | [auth-database-schema.md](auth-database-schema.md)               | `profiles`, `internal_roles`, `tenants`, `seats`                                                                                                                                         | User accounts, staff roles/permissions, tenant seats               |
| 2   | ATECO Taxonomy      | [ateco-database-schema.md](ateco-database-schema.md)             | `ateco`, `ateco_crosswalk`                                                                                                                                                               | Economic activity codes (multi-version), version migration mapping |
...
| ---------------------------- | ----------- | ---------------------------------------------------------------------------- |
| `seat_role`                  | auth        | `owner`, `operator`, `viewer`                                                |
